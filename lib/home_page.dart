...
class _HomePageState extends State<HomePage> {
  ...
  Widget build(BuildContext context) {
    ...
    double progress = finishedWorkouts / totalWorkouts * 100;
  ...
  // Function to update workout data in Firestore
  void _updateWorkoutData() {
    FirebaseFirestore.instance.collection('users').doc('user_id').set({
      'finishedWorkouts': _selectedWorkouts,
      'pendingWorkouts': 12 - _selectedWorkouts - 1,
      'date': DateTime.now(),
    });
  }
}
...
//     // Replace 'pr@gmail.com' with the actual user's email
//     String userEmail = 'pr@gmail.com';
...
//       'pendingWorkouts': 12 - _selectedWorkouts - 1,
//       'date': DateTime.now(),
//       'progress': (_selectedWorkouts + 1) / 12 * 100,
//     });
//   }
// }
